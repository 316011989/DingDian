 ...
 */
public final class RelationAssistN implements AssistPlay {

    private final String TAG = "RelationAssistN";
    ...
    public RelationAssistN(Context context) {
        this(context, null);
    }

    public RelationAssistN(Context context, SuperContainer superContainer) {
            ...
            new OnReceiverEventListener() {
                ...
                public void onReceiverEvent(int eventCode, Bundle bundle) {
                    ...
                    if (mOnEventAssistHandler != null)
                        mOnEventAssistHandler.onAssistHandle(RelationAssistN.this, eventCode, bundle);
