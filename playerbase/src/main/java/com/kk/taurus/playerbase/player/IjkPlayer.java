...
public class IjkPlayer extends BaseInternalPlayer {
    ...
    protected IjkMediaPlayer createPlayer() {
        ...
        //10000000微妙
        mMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "timeout", 15000000);
        ...
        mMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT,
                "protocol_whitelist", "rtmp,concat,ffconcat,file,subfile,http,https,tls,rtp,tcp,udp,crypto");
