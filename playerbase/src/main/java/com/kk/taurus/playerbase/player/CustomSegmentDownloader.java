...
public abstract class CustomSegmentDownloader<M extends FilterableManifest<M>> implements Downloader {
     ...
     */
    public CustomSegmentDownloader(
    ...
    /**
     * Returns a list of all downloadable {@link SegmentDownloader.Segment}s for a given manifest.
     *
     ...
     * @return The list of downloadable {@link SegmentDownloader.Segment}s.
    ...
    /**
     * Initializes the download, returning a list of {@link SegmentDownloader.Segment}s that need to be downloaded.
     */
