...
import cn.yumi.daka.ui.adapter.*
import cn.yumi.daka.ui.widget.GridSpacingItemDecoration
import cn.yumi.daka.ui.widget.PlayWindowControllerCover
import cn.yumi.daka.ui.widget.SelectRetioPopupWindow
...
class PlayerUI(private val context: PlayerWindowActivity) {
    ...
    private fun initPullEpisodeView(
        videoData: VideoData,
    ...
    private fun initPullCacheView(videoData: VideoData, resumePlay: () -> Unit) {
        //屏蔽view层事件传递
